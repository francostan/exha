    ...
    <div className="min-h-screen px-8 md:px-16 pt-32 md:pt-28 pb-28">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-12 mb-32">
        <div className="order-2 lg:order-1 lg:col-span-5">
          ...
          <FadeIn delay={150}>
            <p className="text-xl md:text-2xl font-thin italic text-muted-foreground opacity-muted lowercase tracking-wide mb-14">
              what i love
            </p>
          </FadeIn>
        ...
        <FadeIn delay={200} className="order-1 lg:order-2 lg:col-span-6 lg:col-start-7 relative">
          <div className="aspect-[3/4] relative overflow-hidden">
            <Image
              src="/fashion-editorial-woman-vintage-film-photography-c.jpg"
              alt="valentina motta, photographer and creative director, portrait in natural light with vintage film aesthetic"
              fill
